; ModuleID = 'test6Fenced.bc'
source_filename = "test6.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@array_size_mask = external dso_local global i64, align 8
...
define dso_local void @victim_function_v06(i64 %x) #0 {
entry:
  %x.addr = alloca i64, align 8
  store i64 %x, i64* %x.addr, align 8
  %0 = load i64, i64* %x.addr, align 8
  %1 = load i64, i64* @array_size_mask, align 8
  %and = and i64 %0, %1
...
if.then:                                          ; preds = %entry
  ...
  %arrayidx = getelementptr inbounds [0 x i8], [0 x i8]* @array1, i64 0, i64 %3
...
entry:
  ...
  call void @victim_function_v06(i64 %0)
  ret i32 0
}
