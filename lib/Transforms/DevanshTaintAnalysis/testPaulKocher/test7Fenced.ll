...
define dso_local void @victim_function_v07(i64 %x) #0 {
entry:
  %x.addr = alloca i64, align 8
  store i64 %x, i64* %x.addr, align 8
  %0 = load i64, i64* %x.addr, align 8
  %1 = load i64, i64* @victim_function_v07.last_x, align 8
  %cmp = icmp eq i64 %0, %1
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %7 = load i64, i64* @array1_size, align 8
...
if.then7:                                         ; preds = %if.end
  ...
  store i64 %8, i64* @victim_function_v07.last_x, align 8
  br label %if.end8
...
entry:
  ...
  call void @victim_function_v07(i64 %0)
  ret i32 0
}
