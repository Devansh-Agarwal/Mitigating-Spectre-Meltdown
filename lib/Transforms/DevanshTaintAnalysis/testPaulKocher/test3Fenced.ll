...
define dso_local void @leakByteNoinlineFunction(i8 zeroext %k) #0 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @victim_function_v03(i64 %x) #0 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  call void @leakByteNoinlineFunction(i8 zeroext %3)
  br label %if.end
...
entry:
  ...
  call void @victim_function_v03(i64 %0)
  ret i32 0
}
