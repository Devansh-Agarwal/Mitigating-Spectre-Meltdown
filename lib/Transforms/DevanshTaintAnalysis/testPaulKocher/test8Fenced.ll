...
define dso_local void @victim_function_v08(i64 %x) #0 {
entry:
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %arrayidx = getelementptr inbounds [0 x i8], [0 x i8]* @array1, i64 0, i64 %cond
...
entry:
  ...
  call void @victim_function_v08(i64 %0)
  ret i32 0
}
