...
define dso_local void @victim_function_v04(i64 %x) #0 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  %shl = shl i64 %2, 1
  %arrayidx = getelementptr inbounds [0 x i8], [0 x i8]* @array1, i64 0, i64 %shl
...
entry:
  ...
  call void @victim_function_v04(i64 %0)
  ret i32 0
}
