...
define dso_local void @victim_function_v09(i64 %x, i32* %x_is_safe) #0 {
entry:
  %x.addr = alloca i64, align 8
  %x_is_safe.addr = alloca i32*, align 8
  store i64 %x, i64* %x.addr, align 8
  store i32* %x_is_safe, i32** %x_is_safe.addr, align 8
  %0 = load i32*, i32** %x_is_safe.addr, align 8
...
entry:
  ...
  %x_is_safe = alloca i64, align 8
  %call = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i64* %x, i64* %x_is_safe)
  %0 = load i64, i64* %x, align 8
  %1 = bitcast i64* %x_is_safe to i32*
  call void @victim_function_v09(i64 %0, i32* %1)
  ret i32 0
}
